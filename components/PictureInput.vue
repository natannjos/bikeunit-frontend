...
export default {
  ...
  data() {
    return {
      ...
      canvasHeight: 0,
      strings: {
        upload: "<p>Seu dispositivo não suporta upload de arquivos.</p>",
        drag: "Arraste uma imagem ou <br>clique aqui para selecionar",
        tap: "Clique aqui para escolher uma foto <br>da sua galeria",
        change: "Outra Foto",
        aspect: "Paisagem/Retrato",
        remove: "Remover Foto",
        select: "Escolher uma Foto",
        selected: "<p>Foto selecionada com sucesso!</p>",
        fileSize: "O tamanho do arquivo excedeu o limite",
        fileType: "Este tipo de arquivo não é permitido."
      }
    };
  },
  mounted() {
